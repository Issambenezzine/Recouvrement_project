...
//       {/* Barre de recherche */}
//       <div style={{
//         display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '1.5rem',marginLeft: '800px'
//       }}>
...
//       <th style={{ padding: '3px', textAlign: 'center' }}>Nb globals de dossier</th> 
//       <th style={{ padding: '3px', textAlign: 'center' }}>Nb globals de créance</th>
...
//         <td style={{ padding: '8px', textAlign: 'center' }}><FaEye /></td>
//       </tr>
//     ))}
//   </tbody>
// </table>
...
const verifyUser = async () => {
  ...
  const fetchGestionDossier = async () => {
    try {
      const res = await axios.get(`http://${HOST}:${PORT}/admin/getGesionDossier`, {
        withCredentials: true,
      });
      setData(res.data);
    } catch (err) {
                        ...
                        {g.Gestionnaire ? (
                          <FaEye
                            ...
                            onClick={() => {
                              ...
                              navigate(`/admin/gestionnaire/${encodeURIComponent(g.ID)}`);
                            }}
                          />
                        ) : (
