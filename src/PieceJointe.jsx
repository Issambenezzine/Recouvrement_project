...
//         `http://localhost:3004/piece_jointe/get/${dossier.dossier.id}`,
//         {
...
//   };
//   const handleAdd = () => {
//     // setPieces([...pieces, formattedPiece]);
//     fetchPieces()
//     setShowPopup(false);
//   };
//   useEffect(() => {
...
//           {/* <FaPlus
//             style={{ cursor: 'pointer', color: '#800020', fontSize: '16px' }}
...
//                   <td style={{ padding: "10px" }}>{piece.dateAjout}</td>
  ...
  const handleDownload = async (piece) => {
    try {
      ...
      const response = await axios.get(
        `http://localhost:3004/upload/download/${piece.id}`,
        {
          responseType: 'blob',
          withCredentials: true,
        }
