...
const {saveResponsable, blockResponsable, activerResponsable, getGestionGestionnaire,getResponsable,deleteResponsable, updateResponsable, modifyObjectif} = require("../controller/responsableController.js")
const { authorize } = require("../middlewares/auth.js")

router.get('/get',authorize,getResponsable)
...
router.get('/gestionnaire/stats/:responsableId',authorize, getGestionGestionnaire);
router.put("/objectif",authorize,modifyObjectif)
